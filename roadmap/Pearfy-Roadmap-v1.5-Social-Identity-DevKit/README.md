...
**Natureza:** especificação e backlog; não prova que APIs exemplificadas já estão implementadas. **Idioma:** pt-BR. **Baseline:** roadmap consolidado v1.4. **Escopo:** capacidades independentes e opt-in do framework.
...
5. `15`–`16` — backlog, testes e critérios de aceite das capacidades Pearfy.
6. `docs/v1.5/integration/PROMPT-IMPLEMENTAR-V1.5-PEARFY.md` — prompt para evolução independente do framework.
