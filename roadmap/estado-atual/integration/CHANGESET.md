...
Este arquivo descrevia como anexar o adendo a um checkout anterior. No checkout atual, os documentos já estão em `docs/`, e as implementações aplicáveis estão listadas no README e no `backlog/PERFORMANCE-BACKLOG.md`.
