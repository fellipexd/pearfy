...
| Comando | Resultado |
|---|---|
| `bash scripts/test-unit.sh` | 97 testes passaram em Debug; sem os hosts de serviços configurados, os testes de integração externa retornam sem conectar. |
| `bash scripts/test-integrations.sh` | 97 testes passaram em Debug com PostgreSQL e Redis locais reais, incluindo Social, Transaction Manager e migration locking/drift. |
| `bash scripts/test-integrations.sh -c release` | Os mesmos 97 testes passaram em Release com integrações reais, incluindo Social, Transaction Manager e migration locking/drift. |
